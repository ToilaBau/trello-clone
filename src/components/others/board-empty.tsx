  ...
  return (
    <div className="p-4 space-y-12">
      ...
      <div className="flex flex-col items-center justify-center space-y-4">
        <div className="p-4 rounded-full bg-muted-foreground/20">
          <Kanban className="size-5 stroke-5" />
        </div>
        ...
        <Button className="bg-accent dark:text-accent-foreground hover:bg-accent/80 transition-colors ease-in-out cursor-pointer">
          <Plus /> Create you first board
        </Button>
      </div>
    </div>
  );
